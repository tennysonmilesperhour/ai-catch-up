...
export function Pricing() {
  ...
  return (
    <section className="px-6 md:px-12 py-16 md:py-20 max-w-5xl mx-auto">
      <div className="border border-[var(--color-border)] glass-card-static p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div>
